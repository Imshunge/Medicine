...
public class BridgeService extends Service
{
	...
	public void onCreate() {
		super.onCreate();
		Logger.e("tag", "BridgeService onCreate()");
	...
	public void onDestroy() {
		super.onDestroy();
		notifyManager.cancel(R.drawable.icon_camare);
	}
	/**
	 * 
...
//		Logger.e("did",""+did);
		Logger.e(TAG, "PPPPMsgNotify  did:" + did + " type:" + type + " param:"
				+ param);
		if (ipcamClientInterface != null) {
			ipcamClientInterface.BSMsgNotifyData(did, type, param);
		}
...
//	}
	...
	{
//		mNotify2 = new Notification(R.drawable.icon_camare,content, System.currentTimeMillis());
...
//
		mNotify2 = new NotificationCompat.Builder(
				BridgeService.this)
				.setContentTitle("this is a title")
				.setContentText("context")
						// setWhen 显示通知被创建的时间，毫秒为单位，下拉时显示在通知上
				.setWhen(System.currentTimeMillis())
						// SmallIcon使用純alpha 图层的图片进行设计，小图标会显示在 系统状态栏上
				.setSmallIcon(R.drawable.icon_camare)
				.setLargeIcon(
						BitmapFactory.decodeResource(
								getResources(),
								R.drawable.icon_camare))
				.build();
