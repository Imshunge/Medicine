...
public class MobileConstants {
	...
	//URL
	//www服务器临时屏蔽方法:
//	http://www.shssj.net/index2.php?s=/interfaces/User/login/
	public static final String BASE_HOST = "http://192.168.0.169:8080";//"http://demo2.tp-shop.cn";//"http://demo.tp-shop.cn";//
