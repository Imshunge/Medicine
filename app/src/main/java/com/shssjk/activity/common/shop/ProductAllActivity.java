...
//        cartMinusBtn.setOnClickListener(this);
//        cartPlusBtn.setOnClickListener(this);
//        setSelectIndex(2);//初始化页签

        //        监听 购物车数据变化
//        IntentFilter filter = new IntentFilter(MobileConstants.ACTION_SHOPCART_CHNAGE);
//        mDeviceListSugarChangeReceiver = new CartNumberChangeReceiver();
...
//                        emptyLstv.setVisibility(View.INVISIBLE);
