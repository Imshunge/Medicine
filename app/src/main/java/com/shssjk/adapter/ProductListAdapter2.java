...
public class ProductListAdapter2 extends BaseAdapter {
	...
	public ProductListAdapter2(Context context, ItemClickListener listener) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(R.layout.product_list_item2, parent, false);
			//使用减少findView的次数
...
//			holder.bottonLineView = ((View) convertView.findViewById(R.id.product_bottom_line_view));
		...
		//获取该行数据
		Tmenu product1 = (Tmenu) mProductLst.get(position);
...
//				if (mListener != null) {
//					mListener.onItemClickListener((Tmenu)mProductLst.get(position ) );
//				}
//			}
//		 });
