...
//修改地址
public class ConsigneeAddressEditActivity extends BaseActivity implements View.OnClickListener{

    private String TAG = "ConsigneeAddressEditActivity";
...
//    标题
    ...
    public void initSubViews() {
        ...
        //收货人姓名
         consigneeEdtv= (EditText) findViewById(R.id.bankcard_user_edtv);
        //收货人电话
         mobileEdtv= (EditText) findViewById(R.id.bankcard_issuer_edtv);
        //收货地址
        regionTxtv= (TextView) findViewById(R.id.consignee_region_txtv);
        //收货地址
        addressEdtv= (EditText) findViewById(R.id.bank_num_edtv);
        submitBtn= (Button) findViewById(R.id.submit_btn);
        //默认地址开关
         setdefaultSth  = (SwitchButton) findViewById(R.id.bank_setdefault_sth);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case  R.id.submit_btn :
                ...
                }, new SPFailuredListener(ConsigneeAddressEditActivity.this) {
                    @Override
