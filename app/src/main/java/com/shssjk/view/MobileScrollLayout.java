...
public class MobileScrollLayout extends ViewGroup {
	...
	public MobileScrollLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		this.mContext = context;
	}

	public MobileScrollLayout(Context context, AttributeSet attrs, int defStyle) {
