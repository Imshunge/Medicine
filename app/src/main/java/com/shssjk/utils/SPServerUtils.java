 ...
 */
  public static String getConfigValue(String name){
      ...
      List<SPServiceConfig> serviceConfigs = MobileApplication.getInstance().getServiceConfigs();
 ...
 */
    public static String getWorkTime(){
        ...
        if(com.soubao.tpshop.utils.SPStringUtils.isEmpty(worktime)){
 ...
 */
   public static List<String> getHotKeyword(){
       ...
       String hotword = getConfigValue(CONFIG_HOT_KEYWORDS);
        if (!com.soubao.tpshop.utils.SPStringUtils.isEmpty(hotword)) {
            hotwords = com.soubao.tpshop.utils.SPStringUtils.stringToList(hotword, "|");
        }
        return hotwords;
    }
 ...
 */
   public static int getSmsTimeOut(){
        ...
        if (!com.soubao.tpshop.utils.SPStringUtils.isEmpty(timeout)) {
