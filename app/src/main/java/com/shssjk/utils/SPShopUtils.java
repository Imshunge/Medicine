...
public class SPShopUtils {
    ...
    public static boolean isCollected(String goodsID){
        ...
        if (com.soubao.tpshop.utils.SPStringUtils.isEmpty(goodsID) || MobileApplication.getInstance() == null) return false ;

        List<SPCollect> collects = MobileApplication.getInstance().collects;
     ...
     *  @return
     */
    public static boolean isArticleCollected(String articleID){

        if (com.soubao.tpshop.utils.SPStringUtils.isEmpty(articleID) || MobileApplication.getInstance() == null) return false ;
        ...
        for (SPCollect collect : collects) {
            if (collect!=null &&  articleID.equals(collect.getGoodsID())) {
                return true;
            }
        }
        return false;
